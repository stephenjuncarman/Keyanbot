...
module.exports = {
 ...
 const githubToken = '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'; //add your GitHub token 
 const owner = '13065994'; //add your GitHub username 
 const repo = 'Gera-die-beiden-'; //add your repo name
 const branch = 'main';
